...
theme: cool
paginate: true
footer: Cool Theme Example
---

<!-- _class: title -->
<!-- _paginate: false -->

# Cool Theme<small>- SCSS Extension Example -</small>

A cool-toned theme built with SCSS extension
